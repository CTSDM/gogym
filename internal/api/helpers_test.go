...
func createSetDBTestHelper(t testing.TB, s *State, sessionID uuid.UUID, exerciseID int32) int64 {
...
func createExerciseDBTestHelper(t testing.TB, s *State, name string) int32 {
